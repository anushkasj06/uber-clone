...
### Description:
This endpoint is used to authenticate a captain. It validates the input data, checks the captain's credentials, and returns a JSON object containing an authentication token and the captain details if the credentials are valid.
